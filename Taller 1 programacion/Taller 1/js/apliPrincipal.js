    ...
    function getHomePage() {
        return `
            ...
            <article id="descripcion">
                ...
                <figure>
                    <img src="recursos/Imagen 1.jpeg" alt="Wade Wilson" width="200">
                </figure>
            </article>
        `;
    }
        ...
        return `
            ...
            <section>
                ...
                <article>
                    ...
                    <img src="recursos/Imagen 2.jpeg" alt="Vanessa Carlysle" width="250">
                </article>
                <article>
                    <h3>Piotr Rasputin (Coloso)</h3>
                    <p>Un X-Men que intenta guiar a Wade hacia la heroicidad.</p>
                    <img src="recursos/Imagen 3.jpeg" alt="Coloso" width="250">
                </article>
            </section>
            <footer>
